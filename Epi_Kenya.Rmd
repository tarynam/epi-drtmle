...
replace.btwn.tables<-function(datatable1, datatable2, var, ref.var, new.vals){
    library(dplyr)
    datatable1<-arrange(datatable1, datatable1[,var])
    datatable2<-arrange(datatable2, datatable2[,ref.var])
...
replace.btwn.tables2<-function(datatable1, datatable2, id.var, ref.var, new.var, new.vals){
    library(dplyr)
    datatable1<-arrange(datatable1, datatable1[,id.var])
    datatable2<-arrange(datatable2, datatable2[,ref.var])
...
Helminth<-replace.btwn.tables(Helminth, Coenrolled, "StudyID", "TBRU.STUDY.ID", "Joint.Study.ID")
```
...
QFT1<-replace.btwn.tables(QFT1, Coenrolled, "StudyID", "NK.STUDY.ID", "Joint.Study.ID")
...
QFT2<-replace.btwn.tables(QFT2, Coenrolled, "StudyID", "TBRU.STUDY.ID", "Joint.Study.ID")
...
NK<-replace.btwn.tables(NK, Coenrolled, "StudyID", "NK.STUDY.ID", "Joint.Study.ID")
...
TBRU<-replace.btwn.tables(TBRU, Coenrolled, "StudyID", "TBRU.STUDY.ID", "Joint.Study.ID")
...
cohort<-replace.btwn.tables(cohort, Coenrolled, "StudyID", "NK.STUDY.ID", "Joint.Study.ID")
cohort<-replace.btwn.tables(cohort, Coenrolled, "StudyID", "TBRU.STUDY.ID", "Joint.Study.ID")
```
...
ineligible<-read.csv("QFT.missing.csv")
...
Total2<-replace.btwn.tables2(Total, Hel.manual, "StudyID", "StudyID", "HelminthPositive", "HelminthPositive")
Total2<-replace.btwn.tables2(Total2, Hel.manual, "StudyID", "StudyID", "AscarisPositive", "AscarisPositive")
Total2<-replace.btwn.tables2(Total2, Hel.manual, "StudyID", "StudyID", "TricurisPositive", "TricurisPositive")
Total2<-replace.btwn.tables2(Total2, Hel.manual, "StudyID", "StudyID", "SchistosomaPositive", "SchistosomaPositive")
Total2<-replace.btwn.tables2(Total2, Hel.manual, "StudyID", "StudyID", "HookwormPositive", "HookwormPositive")
Total2<-replace.btwn.tables2(Total2, Hel.manual, "StudyID", "StudyID", "SchistosomaIntensity", "SchistosomaIntensity")
...
Total2<-replace.btwn.tables2(Total2, HIV.manual, "StudyID", "StudyID", "cd4", "cd4")
Total2<-replace.btwn.tables2(Total2, HIV.manual, "StudyID", "StudyID", "viral.load", "viral.load")
Total2<-replace.btwn.tables2(Total2, HIV.manual, "StudyID", "StudyID", "WHO.STAGE", "WHO.STAGE")

#Fill in QFT data
QFT.manual<- read.csv("QFT.missing_post.csv")
QFT.manual<- filter(QFT.manual, StudyID %in% QFT.missing$StudyID)
Total2<-replace.btwn.tables2(Total2, QFT.manual, "StudyID", "StudyID", "NIL", "NIL")
Total2<-replace.btwn.tables2(Total2, QFT.manual, "StudyID", "StudyID", "TBAntigen", "TBAntigen")
Total2<-replace.btwn.tables2(Total2, QFT.manual, "StudyID", "StudyID", "Mitogen", "Mitogen")
...
Total2<-replace.btwn.tables2(Total2, Demographic.manual, 
...
Total2<-replace.btwn.tables2(Total2, chest.manual, "StudyID", "StudyID", "CXR.REPORT", "CXR.REPORT")
Total2<-replace.btwn.tables2(Total2, chest.manual, "StudyID", "StudyID", "HHC", "HHC")
Total2<-replace.btwn.tables2(Total2, sputum.manual, "StudyID", "StudyID", "EXPERT.RESULTS", "EXPERT.RESULTS")
Total2<-replace.btwn.tables2(Total2, sputum.manual, "StudyID", "StudyID", "HAIN.TEST.RESULTS", "HAIN.TEST.RESULTS")
Total2<-replace.btwn.tables2(Total2, sputum.manual, "StudyID", "StudyID", "MGIT.Culture", "MGIT.Culture")
Total2<-replace.btwn.tables2(Total2, sputum.manual, "StudyID", "StudyID", "Days.to.MGIT.Culture", "Days.to.MGIT.Culture")
```
