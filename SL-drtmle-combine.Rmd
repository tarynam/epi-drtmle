...
save(SL_tb, file = "/Users/tarynam/Desktop/epi-drtmle/SL_tb.RData")
...
save(cv_tb, file = "/Users/tarynam/Desktop/epi-drtmle/cv_tb.RData")
```

```{r if needed load SL from file}
load("/Users/tarynam/Desktop/epi-drtmle/SL_g.RData")
load("/Users/tarynam/Desktop/epi-drtmle/SL_ltbi.RData")
load("/Users/tarynam/Desktop/epi-drtmle/SL_tb.RData")

load("/Users/tarynam/Desktop/epi-drtmle/cv_g.RData")
load("/Users/tarynam/Desktop/epi-drtmle/cv_ltbi.RData")
load("/Users/tarynam/Desktop/epi-drtmle/cv_tb.RData")
```
...
```{r}
load("/Users/tarynam/Desktop/epi-drtmle/fit_LTBI_HIVneg.RData")
load("/Users/tarynam/Desktop/epi-drtmle/fit_LTBI_HIVpos.RData")
load("/Users/tarynam/Desktop/epi-drtmle/fit_LTBI.RData")

IC_LTBI_HIVneg<-fit_LTBI_HIVneg$ic_drtmle$ic
IC_LTBI_HIVpos<-fit_LTBI_HIVpos$ic_drtmle$ic
IC_LTBI<-fit_LTBI$ic_drtmle$ic

load("/Users/tarynam/Desktop/epi-drtmle/fit_TB_HIVneg.RData")
load("/Users/tarynam/Desktop/epi-drtmle/fit_TB_HIVpos.RData")
load("/Users/tarynam/Desktop/epi-drtmle/fit_TB.RData")
...
###Total
```{r}
lfit<-round(ci(fit_LTBI)[[1]], 4)
tfit<-round(ci(fit_TB)[[1]], 4)
HC<-c(1-(lfit[1,1]+tfit[1,1]),
       1-(lfit[2,1]+tfit[2,1]))

LTBI<-c(paste(lfit[1,1], " (", lfit[1,2], "-", lfit[1,3],")", sep=""),
        paste(lfit[2,1], " (", lfit[2,2], "-", lfit[2,3],")", sep=""))

TB<-c(paste(tfit[1,1], " (", tfit[1,2], "-", tfit[1,3],")", sep=""),
        paste(tfit[2,1], " (", tfit[2,2], "-", tfit[2,3],")", sep=""))
    
Table<-data.frame(rbind(HC, LTBI, TB),
       row.names = c("HC", "LTBI", "TB")
)
names(Table)<-c("SM+", "SM-")
...
kable(Table, caption=paste("p=value=", pval, sep=""))
```

###HIV-
```{r}
lfit<-round(ci(fit_LTBI_HIVneg)[[1]], 4)
tfit<-round(ci(fit_TB_HIVneg)[[1]], 4)
HC<-c(1-(lfit[1,1]+tfit[1,1]),
       1-(lfit[2,1]+tfit[2,1]))
...
Table.neg<-data.frame(rbind(HC, LTBI, TB),
       row.names = c("HC", "LTBI", "TB")
)
names(Table.neg)<-c("SM+", "SM-")
...
pval<-pchisq(teststat.HIVneg, 2, lower.tail=FALSE)
kable(Table.neg, caption=paste("p=value=", pval, sep=""))
```

###HIV+
```{r}
lfit<-round(ci(fit_LTBI_HIVpos)[[1]], 4)
tfit<-round(ci(fit_TB_HIVpos)[[1]], 4)
HC<-c(1-(lfit[1,1]+tfit[1,1]),
       1-(lfit[2,1]+tfit[2,1]))
...
Table.pos<-data.frame(rbind(HC, LTBI, TB),
       row.names = c("HC", "LTBI", "TB")
)
names(Table.pos)<-c("SM+", "SM-")
...
pval<-pchisq(teststat.HIVpos, 2, lower.tail=FALSE)
kable(Table.pos, caption=paste("p=value=", pval, sep=""))
```
...
tbl<-data.frame(cbind(Table.neg, Table.pos))
names(tbl)<-c("HIV- SM+", "HIV- SM-","HIV+ SM+","HIV+ SM-")
kable(tbl, caption=paste("p-value=", pval, sep=" "))
```
